...
mvrnormArma <- function(n, mu, sigma) {
    .Call(`_asthmaModel_mvrnormArma`, n, mu, sigma)
}
...
Cset_settings_var <- function(name, value) {
    .Call(`_asthmaModel_Cset_settings_var`, name, value)
}
...
Cget_settings <- function() {
    .Call(`_asthmaModel_Cget_settings`)
}
...
Cget_runtime_stats <- function() {
    .Call(`_asthmaModel_Cget_runtime_stats`)
}

Xrexp <- function(n, rate) {
    .Call(`_asthmaModel_Xrexp`, n, rate)
}
...
Cset_input_var <- function(name, value) {
    .Call(`_asthmaModel_Cset_input_var`, name, value)
}
...
get_sample_output <- function(year, sex) {
    .Call(`_asthmaModel_get_sample_output`, year, sex)
}

Cget_agent <- function(id) {
    .Call(`_asthmaModel_Cget_agent`, id)
}
...
#' @export
Cget_smith <- function() {
    .Call(`_asthmaModel_Cget_smith`)
}

Ccreate_agents <- function() {
    .Call(`_asthmaModel_Ccreate_agents`)
}
...
Cget_output_ex <- function() {
    .Call(`_asthmaModel_Cget_output_ex`)
}
...
Cget_event <- function(i) {
    .Call(`_asthmaModel_Cget_event`, i)
}
...
Cget_n_events <- function() {
    .Call(`_asthmaModel_Cget_n_events`)
}
...
Cget_agent_events <- function(id) {
    .Call(`_asthmaModel_Cget_agent_events`, id)
}
...
Cget_events_by_type <- function(event_type) {
    .Call(`_asthmaModel_Cget_events_by_type`, event_type)
}
...
Cget_all_events <- function() {
    .Call(`_asthmaModel_Cget_all_events`)
}
...
Cget_all_events_matrix <- function() {
    .Call(`_asthmaModel_Cget_all_events_matrix`)
}

Callocate_resources <- function() {
    .Call(`_asthmaModel_Callocate_resources`)
}

Cget_pointers <- function() {
    .Call(`_asthmaModel_Cget_pointers`)
}

Cdeallocate_resources <- function() {
    .Call(`_asthmaModel_Cdeallocate_resources`)
}

Cdeallocate_resources2 <- function() {
    .Call(`_asthmaModel_Cdeallocate_resources2`)
}

Cinit_session <- function() {
    .Call(`_asthmaModel_Cinit_session`)
}

Cmodel <- function(max_n_agents) {
    .Call(`_asthmaModel_Cmodel`, max_n_agents)
}
